...
set toPublicize=Assembly-CSharp.dll Assembly-CSharp-firstpass.dll Zeepkist.dll ZeepkistNetworking.dll UnityEngine.UIElementsModule.dll UnityEngine.UIElementsNativeModule.dll
